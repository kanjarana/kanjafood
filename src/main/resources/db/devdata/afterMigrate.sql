...
delete from grupo;
delete from grupo__permissao;
delete from permissao;
delete from produto;
delete from restaurante;
delete from restaurante__forma_pagamento;
delete from usuario;
delete from usuario__grupo;
delete from pedido;
...
insert into restaurante__forma_pagamento (restaurante_id, forma_pagamento_id) values (1, 1), (1, 2), (1, 3), (2, 3), (3, 2), (3, 3), (4, 1), (4, 2), (5, 1), (5, 2), (6, 3);
